...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt) and insect is QueenAnt.first: return
...
class HarvesterAnt(Ant):
    ...
    name = 'Harvester'
    implemented = True
    food_cost = params["food_cost"]["harvester_ant"]
...
class ThrowerAnt(Ant):
    ...
    implemented = True
    damage = 1
    food_cost = params["food_cost"]["thrower_ant"]
    min_range = 0
    max_range = INF
    def nearest_bee(self, hive):
        ...
        while search != hive and search != None and len(search.bees) == 0 and dist < self.max_range:
            search = search.entrance
            dist += 1
        
        if search == None or search == hive: return None
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        if not insect.watersafe: insect.reduce_armor(insect.armor)
        # END Problem 3A
...
class FireAnt(Ant):
    ...
    damage = 3
    # BEGIN Problem 4A
    food_cost = params["food_cost"]["fire_ant"]
...
class LongThrower(ThrowerAnt):
    ...
    name = 'Long'
    # BEGIN Problem 4B
    food_cost = params["food_cost"]["longthrower_ant"]
    implemented = True   # Change to True to view in the GUI
    min_range = 5
    # END Problem 4B
...
class ShortThrower(ThrowerAnt):
    ...
    name = 'Short'
    # BEGIN Problem 4B
    food_cost = params["food_cost"]["shortthrower_ant"]
    implemented = True   # Change to True to view in the GUI
    max_range = 3 
    # END Problem 4B
...
class WallAnt(Ant):
    name = 'Wall'
    food_cost = params["food_cost"]["wall_ant"]
    implemented = True

    def __init__(self):
        Ant.__init__(self, params["armor"]["wall_ant"])
...
class NinjaAnt(Ant):
    ...
    # BEGIN Problem 6A
    blocks_path = False
    food_cost = params["food_cost"]["ninja_ant"]
    implemented = True   # Change to True to view in the GUI
    # END Problem 6A
...
class ScubaThrower(ThrowerAnt):
    name = 'Scuba'
    food_cost = params["food_cost"]["scubathrower_ant"]
    implemented = True
    watersafe = True
# END Problem 5B
...
class HungryAnt(Ant):
    ...
    # BEGIN Problem 6B
    time_to_digest = 3
    food_cost = params["food_cost"]["hungry_ant"]
    implemented = True   # Change to True to view in the GUI
    # END Problem 6B
    ...
    def __init__(self):
        # BEGIN Problem 6B
        self.digesting = 0
        Ant.__init__(self, params["armor"]["hungry_ant"])
        # END Problem 6B
...
class BodyguardAnt(Ant):
    ...
    name = 'Bodyguard'
    # BEGIN Problem 7
    food_cost = params["food_cost"]["bodyguard_ant"]
    container = True
    implemented = True   # Change to True to view in the GUI
    # END Problem 7
...
class TankAnt(BodyguardAnt):
    ...
    damage = 1
    # BEGIN Problem 8
    food_cost = params["food_cost"]["tank_ant"]
    container = True
    implemented = True   # Change to True to view in the GUI
    # END Problem 8
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    name = 'Queen'
    # BEGIN Problem 9
    food_cost = params["food_cost"]["queen_ant"]
    implemented = True   # Change to True to view in the GUI
    first = None
    # END Problem 9
    ...
    def __init__(self):
        # BEGIN Problem 9
        self.armor = params["armor"]["queen_ant"]
        if QueenAnt.first == None:
            QueenAnt.first = self
        # END Problem 9
    ...
    def action(self, colony):
        ...
        """
        # BEGIN Problem 9
        if QueenAnt.first is self:
            search = self.place.exit
            while search != None:
                if search.ant:
                    search.ant.double_damage()
                    if search.ant.container and search.ant.ant:
                        search.ant.ant.double_damage()
                search = search.exit
            super().action(colony)
        else:
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 9
        Insect.reduce_armor(self, amount)
        if QueenAnt.first is self and self.armor <= 0: bees_win()
        # END Problem 9
...
def make_slow(action):
    ...
    def slow_action(colony):
        if colony.time % 2 == 0: action(colony)
    return slow_action
    # END Problem EC
